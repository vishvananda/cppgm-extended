...
protected:
		...
		Operand* result)
	{
		...
		if (intrinsic.kind == hosted_builtin::INTEGER_INTRINSIC_CLZG ||
			intrinsic.kind == hosted_builtin::INTEGER_INTRINSIC_CTZG)
		{
		...
		Operand* result)
	{
		...
		// The libm family is an ordinary call to the C function; nothing here
		// lowers it.
		if (hosted_builtin::IsExternalLibmOperation(intrinsic.operation))
			return false;
		...
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_EXPONENT_OUT:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_EXPONENT_IN:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_LONG_EXPONENT_IN:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_PART_OUT:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_QUOTIENT_OUT:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_WIDE_SECOND:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_TO_INT:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_TO_LONG:
		case hosted_builtin::FLOATING_OPERATION_EXTERNAL_LIBM_TO_LONG_LONG:
