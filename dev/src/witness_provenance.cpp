...
#define CPPGM_PRODUCER_NAME(value, text) \
  ...
  CPPGM_PRODUCER_NAME(ClassCallsemantic09, "class.callsemantic.09");
  ...
  CPPGM_PRODUCER_NAME(ClassCallsemantic12, "class.callsemantic.12");
  CPPGM_PRODUCER_NAME(ClassCallsemantic13, "class.callsemantic.13");
  CPPGM_PRODUCER_NAME(ClassCallsemantic14, "class.callsemantic.14");
  ...
  CPPGM_PRODUCER_NAME(ClassConstantValueLookup01, "class.constant_value_lookup.01");
  ...
  CPPGM_PRODUCER_NAME(ClassConstantValueLookup04, "class.constant_value_lookup.04");
  CPPGM_PRODUCER_NAME(ClassConstantValueLookup05, "class.constant_value_lookup.05");
  ...
  CPPGM_PRODUCER_NAME(ClassSemanticTemplateClass, "class.semantic_template_class");
  ...
  CPPGM_PRODUCER_NAME(AliasTemplateSpecialization02,
                      "alias.template_specialization.02");
  CPPGM_PRODUCER_NAME(AliasCallsemantic01, "alias.callsemantic.01");
  ...
  CPPGM_PRODUCER_NAME(LifecycleTemplateArgumentSemantics01,
                      "lifecycle.template_argument_semantics.01");
  CPPGM_PRODUCER_NAME(LifecycleTemplateArgumentSemantics02,
