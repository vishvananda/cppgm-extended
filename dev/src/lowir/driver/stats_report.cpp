	...
	const lowir_opt::Stats& stats)
{
	output << "pa37_opt_stats"
		 ...
		 << " effect_free_loops_removed=" << stats.effect_free_loops_removed
		 << " fill_loops_recognized=" << stats.fill_loops_recognized
		 << " phi_address_loads_forwarded=" << stats.phi_address_loads_forwarded
		 ...
		 << " inline_eh_fold_attempts=" << stats.inline_eh_fold_attempts
		 << " inline_eh_fold_calls=" << stats.inline_eh_fold_calls
		 ...
		 << " diamond_value_numberings=" << stats.diamond_value_numberings
		 << " diamond_select_identities=" << stats.diamond_select_identities
		 << " diamond_condition_reuses=" << stats.diamond_condition_reuses
