...
5. No open PA18 correctness, architecture, performance, self-containment, or
...
direct `TypedProgram` LowIR -> one textual PA18 view. Parser, syntax, lookup,
substitution, and demand scratch are destroyed before lowering. PA18 has no
...
- `make test-pa18`: pass, 400/400 assignment tests and 10/10 course tests.
...
- Baseline primary log: 3,049/3,049 through PA18, all 23 tracked stages pass.
- `make test-report-through-pa18`: pass, 3,049/3,049 tests and all 23 tracked
  stages.
- `git diff --check`: pass.
...
| Final conversion/materialization and fixture (`8da6b98e`-`eba6ec3`) | Preserved at 410/410 PA18 tests. |
