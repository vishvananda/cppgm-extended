...
semantic facts flow directly through the PA25 adapter; no textual LowIR or
...
cleanup/catch regressions (including the PA25 copy-constructor case) also link
...
nested/multi-frame cleanup boundary and is not claimed as PA26 runtime support.
...
- PA26 local/course tests: 18/18 pass.
- File audit: pass with 21 inherited non-fatal warnings.
- Through-PA26 report: 4,150/4,150 tests; 31/31 stages.
- `git diff --check`: pass.
