...
| `host.object_attribute` | `pa32` | 200 | N/A: host object linkage and section contract | pending | GNU `weak`, `section`, and `noinline` attributes when they control host-object symbol binding, section placement, or inspection visibility. Broader hosted attribute parsing remains PA34-owned. |
