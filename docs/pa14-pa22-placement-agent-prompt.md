# PA14-PA22 Test Placement Agent Prompt
...
- `docs/pa14-pa22-contract-test-audit-plan.md`
- `docs/pa14-pa22-contract-test-audit-tracker.md`
...
```sh
python3 scripts/audit_pa_feature_placement.py --pa pa14 --pa pa15 --pa pa16 \
  --markdown-out /tmp/pa14-pa16-feature-audit.md \
  --json-out /tmp/pa14-pa16-feature-audit.json \
  --csv-out /tmp/pa14-pa16-feature-audit.csv
```
