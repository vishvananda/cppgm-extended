> Historical review of the retired CY86 translator, preserved from
> `pa13/plan.md` at the consolidation baseline. PA13 now introduces
> the LowIR model, reader/writer, and construction exercises; this
> review is not a current assignment contract. Paths below are historical.
