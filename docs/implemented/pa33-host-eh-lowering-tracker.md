# PA33 Host EH Lowering Tracker

This tracker records the explicit host-EH review for the current `PA33` owner
surface.
...
This host-EH review tranche is complete for the current `PA33` owner surface.
...
owner bucket. Future work in this area should come back only if a new `PA33`
