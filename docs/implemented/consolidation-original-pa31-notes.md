> Historical implementation notes for original PA31.
> Assignment numbers, tool names, and paths below use the
> pre-consolidation course. The current handout is authoritative.
