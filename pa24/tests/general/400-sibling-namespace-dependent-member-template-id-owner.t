// Reduced from Boost.Xpressive result traits. A sibling namespace with the
// same name as a class member must not steal the owner of a dependent member
// template-id in a member typedef.
