...
| `016-pa34-function-reference-parameter-shape` | `pa34/tests/link/701-hosted-function-reference-parameter-link-smoke.t.1` | function-reference-shaped argument binds through `const Fn&` |
| `017-pa33-forward-array-shape` | `pa33/tests/compile/656-forward-array-string-pair.t` | forwarding reference preserves an lvalue array shape |
...
`pa33/tests/compile/542-local-functor-std-function-assignment.t` is not one
...
- `016-pa34-function-reference-parameter-shape`
