...
| `016-pa36-function-reference-parameter-shape` | `pa36/tests/link/701-hosted-function-reference-parameter-link-smoke.t.1` | function-reference-shaped argument binds through `const Fn&` |
...
- `016-pa36-function-reference-parameter-shape`
