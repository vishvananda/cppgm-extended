...
DEFAULT_BENCHMARKS = [
    {
        ...
        "source": "pa10/tests/general/200-template-function-body.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "template-body"],
    },
    {
        "name": "pa10-template-class-body-ast",
        "source": "pa10/tests/general/200-template-class-body.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "class-template"],
    },
    {
        "name": "pa10-forward-unknown-nested-template-ast",
        "source": "pa10/tests/general/200-forward-unknown-nested-template-in-ctor-body.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "nested-template"],
    },
    {
        "name": "pa10-member-template-less-greater-ast",
        "source": "pa10/tests/general/200-member-template-if-less-template-call.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "angle-disambiguation"],
    },
    {
        "name": "pa10-template-function-pointer-ast",
        "source": "pa10/tests/general/200-template-id-function-pointer-argument.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "template-id"],
    },
    {
        "name": "pa10-dependent-template-keyword-ast",
        "source": "pa10/tests/general/200-dependent-template-keyword-nested-angle.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "nested-angle"],
    },
    {
        "name": "pa10-nested-qualified-template-id-ast",
        "source": "pa10/tests/general/200-nested-qualified-template-id-template-args.t",
        "mode": "emit-ast",
        "tags": ["pa10", "ast", "qualified-template-id"],
    },
    {
        "name": "pa19-template-shift-stress-lowir",
        "source": "pa19/tests/general/100-template-operator-shift-stress-chain.t",
        "mode": "emit-lowir",
        "tags": ["pa19", "lowir", "operator-template"],
    },
    {
        "name": "pa20-pack-forward-lowir",
        "source": "pa20/tests/general/200-function-template-pack-forward-call.t",
        "mode": "emit-lowir",
        "tags": ["pa20", "lowir", "pack"],
    },
    {
        "name": "pa19-repeated-template-call-lowir",
        "source": "pa19/tests/spec/100-repeated-implicit-function-template-call.t",
        "mode": "emit-lowir",
        "tags": ["pa19", "lowir", "template-cache"],
    },
    {
        "name": "pa24-inline-class-template-member-lowir",
        "source": "pa24/tests/general/100-inline-class-template-member-required-output.t",
        "mode": "emit-lowir",
        "tags": ["pa24", "lowir", "class-template"],
    },
    {
        "name": "pa20-local-variable-template-lowir",
        "source": "pa20/tests/general/100-local-variable-template-keeps-concrete-class-instantiation.t",
        "mode": "emit-lowir",
        "tags": ["pa20", "lowir", "variable-template"],
    },
    {
        "name": "pa22-partial-specialization-alias-lowir",
        "source": "pa22/tests/general/400-partial-specialization-alias-pattern.t",
        "mode": "emit-lowir",
        "tags": ["pa22", "lowir", "alias-template"],
    },
]
