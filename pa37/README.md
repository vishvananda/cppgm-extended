...
- **One design** is how the course solution meets that bar, pass by pass,
  ...
  example.  A different optimizer that meets the bar is a correct PA37; a
...
The canonicalization is the one `../pa13/lowir.md` defines ("What The
