// Reduced from Boost.MP11 mp_repeat_3. Expanding a large type pack through an
// intermediate class template must not hit the reference-member collection
// depth guard before the recursive member aliases finish resolving.
