// VALIDATION: run-pass
// Reduced from Boost.Core string_view conversion to std::basic_string.
// A conversion function template declared in a class template must substitute
// both the owner class argument and the function template argument in its
// conversion result before copy-initialization viability is checked.
