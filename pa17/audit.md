...
2. **The lowering boundary retained earlier-phase owners.**
   `GraphLowerer` was invoked from `SemanticAnalyzer::Consume`, inside the PA5
...
No functional correctness failure, missing PA17 semantic fact, fallback lookup,
...
- `make test-pa17`: pass, 308/308 handout tests and 2/2 course tests.
- `make test-report-through-pa17`: pass, 2,639/2,639 tests and 22/22 stages.
