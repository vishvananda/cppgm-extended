...
The course solution’s `-O1` includes these semantic-preserving pass families where safe:
...
The course solution’s `-O2` includes all `-O1` scalar cleanup and additionally support these
